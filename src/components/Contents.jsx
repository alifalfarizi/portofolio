            ...
            >
                ...
                <div className="container mx-auto px-8 sm:px-16 text-center z-10">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 lg:gap-10 text-center">
                        {[
                            { name: "HTML", src: "/svg/html-1.svg" },
                            { name: "CSS3", src: "/svg/css-3.svg" },
                            { name: "JavaScript", src: "/svg/javascript-1.svg" },
                            { name: "Python", src: "/svg/python-5.svg" },
                            { name: "PHP", src: "/svg/php.svg" },
                            { name: "MySQL", src: "/svg/mysql-logo-pure.svg" },
                            { name: "Laravel", src: "/svg/laravel-2.svg" },
                            { name: "Codeigniter", src: "/svg/codeigniter.svg" },
                            { name: "Debian", src: "/svg/debian-2.svg" },
                            { name: "Ubuntu", src: "/svg/ubuntu-4.svg" },
                            { name: "Mikrotik", src: "/svg/mikrotik.svg" },
                            { name: "Cisco", src: "/svg/cisco-2.svg" },
                        ].map((skill, index) => (
                            <div
                                key={index}
            ...
            >
                ...
                <div className="container mx-auto px-4 py-12    ">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                        {[
                            { id: 1, company: "RC Glow7", year: "Apr 2024 - Aug 2024", position: "Graphic Design", image: "/logorc.png" },
                            { id: 2, company: "PT Nexa Media Pratama", year: "May 2024 - Jul 2024", position: "Programmer", image: "/logonexa.png" },
                            { id: 3, company: "FIK Telkom University", year: "Okt 2023 - Mar 2024", position: "Web Development", image: "/logofik.png" },
                        ].map((item) => (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {[
                            { id: 4, company: "Forum Komunikasi Siswa Kota Bandung", year: "Apr 2022 - Nov 2023", position: "Interest and Talent Division", image: "/logofokus.png" },
                            { id: 5, company: "Organisasi Siswa Intra Sekolah", year: "Nov 2024 - Nov 2023", position: "Vice President of Student Council", image: "/logoosis13.png" },
                        ].map((item) => (
                            <div key={item.id} className="flex flex-col items-center">
                                <img
                                    src={item.image}
